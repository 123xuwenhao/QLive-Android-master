...
public class JoinRoomRequst extends BaseRequest {

    private static final String Action = "http://47.99.171.180:8080/zhibo/servlet/RoomServlet?action=joinRoom&";
    ...
    public void request(JoinRoomRequst.getWatcherParam param) {
