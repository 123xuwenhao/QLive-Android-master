...
public class VipEnterView extends RelativeLayout {
    ...
    private List<UserInfo> vipProfile = new LinkedList<UserInfo>();
    ...
    public void showVipEnter(UserInfo userProfile) {
        ...
        if (isAvaliable) {
            ...
            VipEnterView.this.post(() -> VipEnterView.this.startAnimation(viewAnimation));
        } else {
